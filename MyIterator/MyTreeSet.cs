...
public class MyTreeSet<E> where E : IComparable<E>
{
    ...
    public MyTreeSet(ICollection<E> collection)
    {
    ...
    public void AddAll(ICollection<E> collection)
    {
        foreach (var element in collection.ToArray()) map.Put(element, default);
    }
    ...
    public bool ContainsAll(ICollection<E> collection)
    {
    ...
    public void RemoveAll(ICollection<E> collection)
    {
        foreach (var element in collection.ToArray()) map.Remove(element);
    }

    public void RetainAll(ICollection<E> collection)
    {
    ...
    public MyTreeSet<E> SubSet(E fromElement, E toElement) => new MyTreeSet<E>((MyTreeMap<E, int>)map.SubMap(fromElement, toElement));

    public MyTreeSet<E> HeadSet(E toElement) => new MyTreeSet<E>((MyTreeMap<E, int>)map.HeadMap(toElement));

    public MyTreeSet<E> TailSet(E fromElement) => new MyTreeSet<E>((MyTreeMap<E, int>)map.TailMap(fromElement));
